          ...
          <div id="myTabContent" class="tab-content category-list">
            <div class="tab-pane active " id="grid-container">
              <div class="category-product">
                <div class="row">
                  <!-- all products loop start -->
                  @foreach($allProducts as $a_p)
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> 
                            <a href="{{route('product.show',$a_p->slug)}}">
                                  @php 
                                  $j=1; 
                                  @endphp

                                  @foreach ( $a_p->images as $img)
                                    @if ( $j > 0)
                                      <img src="{{asset('backend/img/products/'.$img->image)}}">
                                    @endif
                                    @php $j-- ; 
                                    @endphp
                                  @endforeach
                        ...
                        <div class="product-info text-left">
                          <h3 class="name">
                            <a href="{{route('product.show',$a_p->slug)}}">{{$a_p->title}}</a>
                          </h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> 
                              @if(!is_null($a_p->offer_price))
                              <span class="price"> $ {{$a_p->offer_price}} </span> 
                              <span class="price-before-discount">$ {{$a_p->price}}</span> 
                              @else
                                <span class="price">$ {{$a_p->price}}</span> 
                              @endif
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <li class="lnk wishlist"> <a class="add-to-cart" href="{{route('product.show',$a_p->slug)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                              <li class="lnk"> <a class="add-to-cart" href="{{route('product.show',$a_p->slug)}}" title="Compare"> <i class="fa fa-signal"></i> </a> </li>
                            </ul>
                          </div>
                          <!-- /.action --> 
                        </div>
