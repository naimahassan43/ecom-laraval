...
<section class="section featured-product wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs" style="opacity: 1; display: block;">
		...
		<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 2040px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 170px;"><div class="item item-carousel">
			<div class="products">
	...
	<div class="product">		
		...
		</div></div><div class="owl-item" style="width: 170px;"><div class="item item-carousel">
			<div class="products">
