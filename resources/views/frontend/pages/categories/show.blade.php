                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          <h3 class="name">
                            <a href="{{route('product.show',$cat->slug)}}">{{$cat->title}}</a>
                          </h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> 
                              @if(!is_null($cat->offer_price))
                              <span class="price"> $ {{$cat->offer_price}} </span> 
                              <span class="price-before-discount">$ {{$cat->price}}</span> 
                              @else
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <li class="lnk wishlist"> <a class="add-to-cart" href="{{route('product.show',$cat->slug)}}" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                              <li class="lnk"> <a class="add-to-cart" href="{{route('product.show',$cat->slug)}}" title="Compare"> <i class="fa fa-signal"></i> </a> </li>
                            </ul>
                          </div>
                          <!-- /.action --> 
                        </div>
