                ...
                <div class="products">
                  <div class="product">
                    <div class="product-image">
                      <div class="image"> 
                        <a href="{{route('product.show',$recentItem->slug)}}">
                        @php 
                        $j=1; 
                        @endphp

                        @foreach ( $recentItem->images as $img)
                          @if ( $j > 0)
                    ...
                    <div class="product-info text-left">
                      <h3 class="name">
                        <a href="{{route('product.show',$recentItem->slug)}}">{{$recentItem->title}}</a>
                      </h3>
                      <div class="rating rateit-small"></div>
                      <div class="description"></div>
                      <div class="product-price"> 
                        @if(!is_null($recentItem->offer_price))
                          <span class="price"> $ {{$recentItem->offer_price}} </span> 
                          <span class="price-before-discount">$ {{$recentItem->price}}</span> 
                        @else
                          <span class="price">$ {{$recentItem->price}}</span> 
                        @endif
