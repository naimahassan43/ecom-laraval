            ...
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown yamm-fw"> 
                  <a href="{{route('product.all')}}" class="dropdown-toggle">All Products</a> 
                </li>
                <li class="dropdown yamm mega-menu"> <a href="{{route('homepage')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Clothing</a>
