...
<div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            ...
            @foreach(App\Models\Backend\Category::orderBy('name','asc')->where('parent_id', 0)->get() as $parentCat)
              <li class="dropdown menu-item"> 
                <a href="{{route('category.show', $parentCat->id)}}" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="icon fa fa-shopping-bag" aria-hidden="true"></i>{{$parentCat->name}}
                </a>
                  ...
                  <li class="yamm-content">
                    <div class="row">
                      ...
                      <div class="col-sm-3 col-md-3">
                        ...
                        @foreach(App\Models\Backend\Category::orderBy('name','asc')->where('parent_id', $parentCat->id)->get() as $childCat)
                          <li><a href="{{route('category.show', $childCat->id)}}">{{$childCat->name}}</a></li>
                        @endforeach
                        </ul>
                      </div>
                      <!-- /.col -->
