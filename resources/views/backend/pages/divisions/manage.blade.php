  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage All Divisions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12 col-sm-12 col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">All Divisions Lists</h3>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteDivision{{$division->id}}">Delete</a>
